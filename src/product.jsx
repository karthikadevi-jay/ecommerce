        ...
        <div className="col-lg-6">
            <div className="card m-1">
                <div className="card-body">
                    ...
                    <div className="mt-2 text-muted">#{prod.brand.brandName}{" "}#{prod.catagory.categoryName}</div>
                    <div>
                    ...
                    <div className="float-right">
                        {prod.isOrdered ? <span className="text-primary">Added to cart</span> : (
                            <button className="btn btn-sm btn-primary" onClick={() => { props.onAddToCartClick(prod) }}>
                                <i className="fa fa-cart-pluse"></i>Add to cart</button>)}
                    </div>
                </div>
            </div>
        </div>
